...
int main(int argc,char **argv){
  ...
  fout<<" xsi:noNamespaceSchemaLocation=\"face_detection.xsd\">" << endl;
  fout << "<face_detection_data>" << endl;
  while (1){
    cap >> frame;
    ...
    if (out.size()>0){
      ...
      for(int i=0;i<out.size();i++){
        ...
        fout << " <o" <<i+1<< "_label>" << "Unknown" << "</o" <<i+1<< "_label>" << endl;
      }
      /*for(int i=out.size(); i<5; i++){
        fout << " <o" <<i+1<< "_x>" << (int)0 << "</o" <<i+1<< "_x>" << endl;
        fout << " <o" <<i+1<< "_y>" << (int)0 << "</o" <<i+1<< "_y>" << endl;
        fout << " <o" <<i+1<< "_width>" << (int)0 << "</o" <<i+1<< "_width>" << endl;
        fout << " <o" <<i+1<< "_height>" << (int)0 << "</o" <<i+1<< "_height>" << endl;
        fout << " <o" <<i+1<< "_label>" << "Unknown" << "</o" <<i+1<< "_label>" << endl;
      }*/
      fout << "</row>" << endl;
    }
